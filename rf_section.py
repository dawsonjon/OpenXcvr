...
def rf_section(clk, frequency, audio_i, audio_q, audio_stb, interpolation_factor, lut_bits, channels, settings):
    ...
    rf = [i.subtype.select(settings.rx_tx, 0, i) for i in rf]
